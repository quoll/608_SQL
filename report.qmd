...
This project expands on using the contents of the [Shopping Trends](https://github.com/quoll/608_HW3_ERModels/blob/main/shopping_trends.csv) file from Assignment 3. The repository containing all of the sources and data for this assigment is on [Github](https://quoll.github.io/608_SQL).
...
## Supporting Files
### Script
Extracting the individual table data from the original CSV was done via a scripting language. This was necessary to extract the data that appears in separate tables and addressed by foreign keys. The language used was Clojure, or in this case it was Babashka as this is a "scripting" variant. The code can be found in [`scripts/extract.bb`](https://quoll.github.io/608_SQL/scripts/extract.bb).

### Data Definition Language
The Data Definition Language file (DDL) was hand generated and defines each of the tables, along with their foreign keys. This can be found in [`data/definitions.sql`](https://quoll.github.io/608_SQL/data/definitions.sql)
...
The data is found in [`data/data.sql`](https://quoll.github.io/608_SQL/data/data.sql)
